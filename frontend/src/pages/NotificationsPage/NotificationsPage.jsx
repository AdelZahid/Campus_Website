...
const NotificationsPage = () => {
  ...
  const getFilteredNotifications = () => {
    switch (activeFilter) {
      ...
      case 'helpdesk':
        return notifications.filter(notification => notification.type === 'helpdesk');
      default:
    ...
    <div className="notifications-page">
      ...
      <div className="notifications-container">
        ...
        <div className="notifications-filters">
          ...
          <button 
            className={`filter-btn ${activeFilter === 'helpdesk' ? 'active' : ''}`}
        ...
        <div className="notifications-list">
          {isLoading ? (
            ...
            filteredNotifications.map(notification => (
              ...
              >
                <div className="notification-icon" data-type={notification.type}>
                  {notification.type === 'message' && <i className="fas fa-comment-alt"></i>}
                  {notification.type === 'friend' && <i className="fas fa-user-friends"></i>}
                  {notification.type === 'event' && <i className="fas fa-calendar-check"></i>}
                  {notification.type === 'helpdesk' && <i className="fas fa-question-circle"></i>}
                  {notification.type === 'university' && <i className="fas fa-university"></i>}
                </div>
                ...
                <div className="notification-content">
                  ...
                  {notification.actionLink && (
                    <Link to={notification.actionLink} className="notification-action">
                      {notification.actionText} <i className="fas fa-arrow-right"></i>
                    </Link>
                  )}
                </div>
            ...
            <div className="empty-notifications">
              ...
              <p>You don't have any {activeFilter !== 'all' ? activeFilter : ''} notifications at the moment.</p>
            </div>
          )}
        </div>
      </div>
...
const sampleNotifications = [
  {
    ...
    message: 'Hey, did you get the notes from yesterday's lecture?',
    time: '10 minutes ago',
    isRead: false,
    actionLink: '/messages',
  ...
  },
  {
    ...
    message: 'Sarah Johnson replied to your question about machine learning courses.',
    time: '2 hours ago',
    isRead: true,
