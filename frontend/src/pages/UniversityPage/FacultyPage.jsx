    ...
    <div className="faculty-page">
      ...
      <div className="faculty-hero">
        <div className="hero-content">
          ...
          <p>
            Learn from world-renowned experts and leading researchers in their
            fields
          </p>
                ...
                <div className="faculty-header">
                  ...
                  <div className="faculty-intro">
                    ...
                    <div className="faculty-contact">
                      <p>
                        <i className="far fa-envelope"></i> {member.email}
                      </p>
                      <p>
                        <i className="far fa-building"></i> {member.office}
                      </p>
                    </div>
                  </div>
                </div>
