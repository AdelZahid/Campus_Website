...
const ProgramsPage = () => {
  ...
  const programs = [
    {
      ...
      university: "MIT",
      description:
        "A comprehensive program covering algorithms, software development, artificial intelligence, and more.",
      credits: 120,
      tuition: "$52,000/year",
    ...
    },
    {
      ...
      description:
        "Develop leadership skills and business acumen through case studies and practical experience.",
      credits: 60,
      tuition: "$65,000/year",
    ...
    },
    {
      ...
      description:
        "Study ecosystems, climate change, and sustainable development practices.",
      credits: 90,
      tuition: "$49,000/year",
      career: [
    ...
    },
    {
      ...
      description:
        "Learn to extract insights from complex data using statistics, programming, and machine learning.",
      credits: 45,
      tuition: "$55,000/year",
      career: [
        "Data Scientist",
    ...
    },
    {
      ...
      description:
        "Explore human behavior, cognition, and mental processes through research and theory.",
      credits: 120,
      tuition: "$50,000/year",
    ...
    },
    {
      ...
      description:
        "Advanced study of machine learning, robotics, and cognitive systems.",
      credits: 60,
      tuition: "$58,000/year",
  ...
  const filteredPrograms = programs.filter((program) => {
    ...
    const matchesField =
      filters.field === "all" || program.field === filters.field;
    const matchesDuration =
      filters.duration === "all" || program.duration === filters.duration;
